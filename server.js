...
server.post('/public/login', (req, res) => {
  ...
  if (!usuarioExiste({ email, senha })) {
    ...
    const alert = 'IIIIHHHSSHH DEU RUIM!!!!'
    res.status(status).json({ status, message, alert })
    return
  }
  const access_token = createToken({ email, senha })
...
server.get('/public/foods', (req, res) => {
  res.status(200).json([
    {
      "foods": [
        {
          ...
          "condimentacao": "Pão Brioche, Burguer Artesanal, Alface, Tomate, Cebola, Queijo cheddar",
          "price": 25.99
        },
        {
          "id": 2,
          "description": "Andrômeda",
          "condimentacao": "Pão Crocante, Burguer Artesanal, Cebola, Queijo cheddar, 3 fatias de bacon, Maionese, Catchup ",
          "price": 38.99
        },
        {
          "id": 3,
          "description": "Galáxia do Sombrero",
          "condimentacao": "Pão Brioche, 2 Burgueres Artesanal, Bacon, Queijo, Cebola roxa, Maionese ",
          "price": 42.99
        },
        {
          "id": 4,
          "description": "Galáxia do Triângulo",
          "condimentacao": "Pão Australiano, Burguer Artesanal,Mussarela Cream Cheese, Alface, Tomate   ",
          "price": 32.99
        },
        {
          "id": 5,
          "description": "Galáxia do Redemoinho",
          "condimentacao": "Pão Australiano, Buguer bovino,  Molho especial, Alface, Queijo, Picles",
          "price": 25.99
        },
        {
          "id": 6,
          "description": "Grande Nuvem de Magalhães",
          "condimentacao": "Pão Brioche, Bacon,  Ketchup, Mostarda, Maionese, Cebola frita",
          "price": 17.99
        }
      ],
      "bebidas": [
